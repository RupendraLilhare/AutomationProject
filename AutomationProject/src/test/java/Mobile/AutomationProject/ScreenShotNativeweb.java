...
public class ScreenShotNativeweb {
	...
	//driver.findElement(By.cssSelector("//*[@class='android.widget.TextView'][6]")).click();
		...
		catch (Exception e) 
		{
			...
			FileUtils.copyFile(srcFile, new File("C:\\Users\\QQA0464\\eclipse-workspace\\AutomationProject\\target\\faill.png"));
		}
	}
